                ...
                child: Padding(
                  ...
                  Container(
                    ...
                    Padding(
                      ...
                      child: Text(values.docs[index]["sender"],style: TextStyle(color: Colors.black),),
                    ),
                      Text(values.docs[index]["text"],style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)
                  ]),
                  ),
                ),
              );
